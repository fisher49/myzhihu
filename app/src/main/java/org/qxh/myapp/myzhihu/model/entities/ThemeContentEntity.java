...
public class ThemeContentEntity {
    ...
    public ThemeContentEntity(String description, String background, int color, String name, String image, String image_source, List<StoriesEntity> stories, List<EditorsEntity> editors) {
    ...
    public static class StoriesEntity {
        ...
        public StoriesEntity(int type, int id, String title, List<String> images) {
            this.type = type;
            this.id = id;
            this.title = title;
            this.images = images;
